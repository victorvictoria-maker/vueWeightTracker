        ...
        data: {
          ...
          datasets: [
            {  
              ...
              backgroundColor: 'rgba(164, 8, 151, 0.2)',
              borderColor: 'rgb(164, 8, 151)',
              borderWidth: 1,
              fill: true
            }
          ]
...
<template>
  <div>
    <main>
      ...
      <form v-on:submit.prevent="addWeight">
      ...
      <div v-if="weights && weights.length > 0">
        ...
        <div class="weight-history">
          ...
          <ul>
            <li v-for="(weight, index) in weights" v-bind:key="index">
...
form input[type="submit"]:hover {
	background-color: white;
	color: rgb(164, 8, 151);
	border-left-color: rgb(164, 8, 151);
}
